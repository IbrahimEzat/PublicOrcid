...
class OrcidPublicProvider extends AbstractProvider
{
    /**
    ...
    /**
     * available Public ORCID scopes:
     * /authenticate    ===> collect the ORCID iD and read public information on the record only
     * openid           ===> return an id_token inside the token response and grant the client permission to access the user info endpoint for that user
    ...
    protected function mapUserToObject(array $user)
    {
        return (new User())->setRaw($user)->map([
            ...
            'name'     => $user['person']['name']['given-names']['value'],
